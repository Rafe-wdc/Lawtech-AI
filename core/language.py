    ...
    *,
    ...
    if lang == "en":
        ...
        fixed_english_anchors = (
            ...
            "statutory references, case-law citations) MUST be emitted as "
            "PLAIN TEXT. Do NOT wrap them in Markdown inline-code "
            "backticks (single `like this` or double ``like this``), "
            "triple-backtick code fences (```like this```), HTML `<code>` "
            "tags, or any other verbatim / literal formatting. They must "
            "render in the SAME proportional font as the surrounding body "
            "prose — not in a monospaced / typewriter font. "
            ...
            "syntax to signal 'do not translate'. Bolding (`**...**`) for "
            "the subject heading of a legal notice or a paragraph label "
            "is fine; italics for emphasis are fine; but the statutory "
            "reference span itself is unformatted running text.\n"
            f"   ✓ CORRECT: '..., Section 138 of the Negotiable "
            f"Instruments Act, 1881 च्या तरतुदींनुसार, ...'\n"
            f"   ✗ WRONG:   '..., `Section 138 of the Negotiable "
            f"Instruments Act, 1881` च्या तरतुदींनुसार, ...' (monospaced)\n"
            f"   ✗ WRONG:   '..., ``Section 138 of the Negotiable "
            f"Instruments Act, 1881`` च्या तरतुदींनुसार, ...' (monospaced)\n"
        )
