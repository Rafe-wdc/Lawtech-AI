    ...
    *,
    ...
    if lang == "en":
        ...
        substantive_depth_policy = (
            ...
            f"paragraph of THREE TO FIVE FULL SENTENCES — state the point, "
            f"give the reasoning that supports it, and apply it to the "
            f"facts. Reducing a point to a single-line assertion when "
            f"reasoning is available is a DEFECT, not brevity.\n"
            f"- CALIBRATION: before you write, ask what this section would "
            f"contain if you were drafting it in English for the same "
            f"matter, then write THAT — in {lang_name}. Measured against "
            f"the English draft, a {lang_name} section that is materially "
            f"shorter has lost legal substance, not merely words. Writing "
            f"in {lang_name} is a change of language, never a licence to "
            f"abbreviate.\n"
