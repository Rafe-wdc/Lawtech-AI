...
$outFile = "_verify_local_phase2_response.json"
Write-Output "Firing at http://127.0.0.1:5001/pyapi/search (PHASE 2 LOCAL) ..."
$sw = [System.Diagnostics.Stopwatch]::StartNew()
try {
    $r = Invoke-RestMethod -Uri "http://127.0.0.1:5001/pyapi/search" `
